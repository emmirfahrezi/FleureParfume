    ...
    <div class="relative isolate px-6 pt-14 lg:px-20 min-h-screen py-10">
        <div class="w-full flex items-center justify-between py-4 border-b border-gray-200">
            <div class="flex items-center gap-3 text-black cursor-pointer">
                ...
                <button onclick="openFilter()" class="flex items-center gap-2 font-medium hover:text-gray-600">
                    Filter Products
                </button>
            </div>
            ...
            <div class="flex items-center gap-6 text-gray-700">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <svg id="listView" onclick="toggleView('list')" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 cursor-pointer text-gray-400 hover:text-black transition" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto mt-12">
            ...
            <div id="productsGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transition hover:shadow-xl group">
                    ...
                    {{-- Info --}}
                    <div class="p-4">
                        <h4 class="text-sm text-gray-500 mb-1" style="font-family: cormorant, serif !important;">
                            {{-- Handle kalau category null --}}
                            {{ $product->category->name ?? 'Women' }}
                        </h4>
                        <h3 class="text-xl font-semibold text-gray-900 truncate" style="font-family: cormorant, serif !important;">
                            {{ $product->name }}
                        </h3>
            ...
            <div id="productsList" class="hidden space-y-4">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transition hover:shadow-xl flex flex-col sm:flex-row group">
                    ...
                    <div class="p-4 sm:p-6 flex flex-col justify-center flex-grow">
                        ...
                        <h3 class="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3" style="font-family: cormorant, serif !important;">
                            {{ $product->name }}
                        </h3>
