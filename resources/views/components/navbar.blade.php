...
<nav id="navbar" class="fixed top-0 left-0 right-0 z-50 py-3 transition-all duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden sm:grid grid-cols-3 h-16 items-center">
            ...
            <div class="flex justify-center">
                <a href="/" class="flex flex-col justify-center items-center group">
                    <span class="brand text-black text-3xl font-bold tracking-widest leading-none group-hover:opacity-80 transition-opacity">FLEURE</span>
                ...
                @else
                    <div class="relative">
                        ...
                        <div id="user-menu" 
                            ...
                            <a href="/profile" class="block px-4 py-3 text-sm text-black hover:bg-black/5 transition-colors">
                                Your Profile
                            </a>
        ...
        <div id="mobileMenu" class="hidden sm:hidden mt-4 pb-4 border-t border-black/10 space-y-1 bg-[#F0E2C6]/95 backdrop-blur-md rounded-b-lg shadow-lg">
            <a href="/" class="block px-4 py-3 text-base font-medium text-black hover:bg-black/5">BUY PERFUMES</a>
            <a href="#" class="block px-4 py-3 text-base font-medium text-black hover:bg-black/5">EXCLUSIVE</a>

            <details class="group">
                <summary class="flex justify-between items-center px-4 py-3 text-base font-medium text-black cursor-pointer hover:bg-black/5">
                    CATEGORIES
            ...
            <div class="border-t border-black/10 mt-2 pt-2">
                <div class="px-4 py-2 text-xs text-gray-500 uppercase">Signed in as {{ optional(auth()->user())->name }}</div>
                <a href="/profile" class="block px-4 py-3 text-base font-medium text-black hover:bg-black/5">Profile</a>
                 <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full text-left block px-4 py-3 text-base font-medium text-red-600 hover:bg-red-50">
                        Logout
                    </button>
                </form>
            </div>
