        ...
        <div class="max-w-7xl mx-auto mt-12">
            ...
            <div id="productsGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ($bestSellers as $product)
                    <div class="card-luxe bg-white rounded-xl overflow-hidden">
                        <div class="relative">
                        ...
                        <div class="p-5 space-y-2">
                            ...
                            <div class="flex items-center justify-between pt-2">
                                <span class="text-sm text-gray-500">Limited release</span>
                                <button class="px-4 py-2 rounded-full text-sm font-semibold text-white"
                                    style="background: linear-gradient(90deg, #d4af37, #b07a2a);">
                                    View details
                                </button>
                            </div>
                        </div>
            ...
            <div id="productsList" class="hidden space-y-4">
                @foreach ($bestSellers as $product)
                    <div class="card-luxe bg-white rounded-xl overflow-hidden flex flex-col sm:flex-row">
                        <img src="{{ asset($product['image']) }}" alt="{{ $product['name'] }}"
                        ...
                        <div class="p-4 sm:p-6 flex flex-col justify-center flex-grow gap-2">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-xs sm:text-sm text-gray-500"
                                    style="font-family: poppins, sans-serif;">{{ $product['category'] }}</span>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900"
                                style="font-family: cormorant, serif !important;">
                                {{ $product['name'] }}</h3>
