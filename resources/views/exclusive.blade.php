    ...
    <div class="relative isolate px-6 pt-14 lg:px-20 min-h-screen py-10">
        ...
        <div class="max-w-7xl mx-auto mt-12">
            ...
            <div id="productsGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="card-luxe bg-white rounded-xl overflow-hidden group">
                    <div class="relative w-full h-64 overflow-hidden">
                        ...
                        {{-- Label Exclusive --}}
                        <span class="absolute top-3 left-3 px-3 py-1 rounded-full text-xs uppercase tracking-wide pill-gold" style="font-family: poppins, sans-serif;">
                            Exclusive
                        </span>
                    </div>
                    ...
                    <div class="p-5 space-y-2">
                        ...
                        <h3 class="text-2xl font-semibold text-gray-900 truncate" style="font-family: cormorant, serif !important;">
                            {{ $product->name }}
                        </h3>
                        <p class="text-gray-700 text-lg" style="font-family: poppins, sans-serif !important;">
            ...
            <div id="productsList" class="hidden space-y-4">
                @foreach ($products as $product)
                <div class="card-luxe bg-white rounded-xl overflow-hidden flex flex-col sm:flex-row group">
                    ...
                    <div class="p-4 sm:p-6 flex flex-col justify-center flex-grow gap-2">
                        <div class="flex items-center gap-3">
                            <span class="px-3 py-1 rounded-full text-xs uppercase tracking-wide pill-gold" style="font-family: poppins, sans-serif;">Exclusive</span>
                            <span class="text-xs sm:text-sm text-gray-500" style="font-family: poppins, sans-serif;">{{ $product->category->name ?? 'Exclusive' }}</span>
                        </div>
                        <h3 class="text-2xl font-semibold text-gray-900" style="font-family: cormorant, serif !important;">
                            {{ $product->name }}
                        </h3>
                        <p class="text-base sm:text-lg text-gray-700" style="font-family: poppins, sans-serif !important;">
                            Rp {{ number_format($product->price, 0, ',', '.') }}
                        </p>
    ...
    <div id="filterSidebar" class="fixed top-0 left-0 h-full w-[360px] bg-white -translate-x-full transition-transform duration-300 ease-in-out z-50 overflow-y-auto">
        ...
        <div class="px-6 mt-14">
            ...
            <ul class="space-y-3 font-semibold text-gray-700">
                <li class="cursor-pointer text-black font-bold">Exclusive</li>
                <li><a href="{{ route('man.index') }}" class="cursor-pointer hover:text-black">Men</a></li>
                <li><a href="{{ route('woman.index') }}" class="cursor-pointer hover:text-black">Women</a></li>
                <li><a href="{{ route('unisex.index') }}" class="cursor-pointer hover:text-black">Unisex</a></li>
            </ul>
        </div>
    </div>
</x-layoutCategories>